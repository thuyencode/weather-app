...
const ForecastDay: Component<IForecastDay> = (props) => {
  return (
    <div class='card flex min-h-36 max-w-32 flex-col justify-between rounded-md border border-base-content/50 bg-base-100 px-3 py-2 text-center text-base-content'>
